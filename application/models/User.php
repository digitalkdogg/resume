...
class User extends CI_Model {
    ...
    public function get($data){
        ...
        $this->db->select('Section_Details.Field_Label, Section_Details.Field_Value, Section_Details.Ele_Id, Section_Details.Field_Type, Section_Type.Name, Resume.Name as resumename');
